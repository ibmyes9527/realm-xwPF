...
download_realm_ocr_script() {
    local script_url="https://gh.henhei.win/https://raw.githubusercontent.com/zywe03/realm-xwPF/main/xw_realm_OCR.sh"
...
download_failover_script() {
    local script_url="https://gh.henhei.win/https://raw.githubusercontent.com/zywe03/realm-xwPF/main/xwFailover.sh"
...
download_speedtest_script() {
    local script_url="https://gh.henhei.win/https://raw.githubusercontent.com/zywe03/realm-xwPF/main/speedtest.sh"
...
port_traffic_dog_menu() {
    local script_url="https://gh.henhei.win/https://raw.githubusercontent.com/zywe03/realm-xwPF/main/port-traffic-dog.sh"
